...
## ⚡ В двух словах
Глобальная точка доступа к сервисам и общим объектам.

## 🎯 Когда использовать
- Нужен централизованный доступ к общим сервисам.
- Хочется избежать пробрасывания зависимостей «вручную».
- Важно быстро получить объект по ключу.
