...
## ⚡ В двух словах
Методы возвращают `$this`, чтобы строить цепочки вызовов.

## 🎯 Когда использовать
- Нужно удобное конфигурирование объекта.
- Хотите сделать код читабельнее при настройках.
- Необходима «цепочка» действий.
