...
Обычно используются две коллекции: **свободные** и **занятые** объекты. Количество объектов в них постоянно меняется.

## ⚡ В двух словах
Object Pool хранит «дорогие» объекты и выдаёт их по запросу, чтобы не создавать заново.

## 🎯 Когда использовать
- Объекты **дорого создавать** или инициализировать.
- Нужен контроль над **количеством активных объектов**.
- Есть частые запросы на однотипные ресурсы.
