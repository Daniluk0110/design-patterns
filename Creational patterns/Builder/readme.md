...
![](https://refactoring.guru/images/patterns/content/builder/builder.png)
...
## ⚡ В двух словах
Builder помогает избежать «телескопического конструктора» и удобно собирать сложные объекты по шагам.

## 🎯 Когда использовать
- Нужен **многошаговый процесс** сборки.
- Конструктор раздувается от множества параметров.
- Хочется **разные варианты** одного объекта без переписывания логики сборки.

## 🧩 Пример из Design Patterns for Humans
_Конструктор бургера с опциональными добавками._
