...
## 🧭 Когда использовать
- Постоянно приходится проверять `null`.
- Нужно **стабильное поведение** без исключений.
- Хотите избавиться от условий в клиентском коде.

## 💡 Ключевые идеи
- Null Object реализует тот же интерфейс.
- Методы делают «ничего», но безопасно.
- Клиентский код становится проще.
