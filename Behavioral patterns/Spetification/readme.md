...
## 🧭 Когда использовать
- Бизнес-правила часто меняются или комбинируются.
- Нужны **гибкие фильтры** и проверки.
- Хотите переиспользовать правила в разных местах.

## 💡 Ключевые идеи
- Каждое правило — отдельная спецификация.
- Спецификации можно объединять (AND/OR/NOT).
- Проверки не «зашиты» в доменную логику.
