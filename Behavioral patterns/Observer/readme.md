## 👀 Паттерн Observer на PHP  
_Издатель-Подписчик, Слушатель, Наблюдатель_
...
## ⚡ В двух словах
Подписчики получают уведомления об изменениях автоматически.

## 🧭 Когда использовать
- Нужна реакция на события без жёстких зависимостей.
- Важно, чтобы **несколько объектов** реагировали на изменения.
- Хотите динамически подписывать/отписывать слушателей.

## 💡 Ключевые идеи
- Есть **издатель** (subject) и **подписчики** (observers).
- Издатель не знает конкретные классы подписчиков.
- Уведомления могут идти в разном порядке.
...
_Соискатели подписываются на вакансии._
